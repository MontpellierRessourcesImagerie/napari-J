# -*- coding: utf-8 -*-
#
# napari-J documentation build configuration file, created by
...
project = u'napari-J'
copyright = u'2015, Volker Baecker'
author = u'Volker Baecker'
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'napari-J Documentation',
     [author], 1)
]
